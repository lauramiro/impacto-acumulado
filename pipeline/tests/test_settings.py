...
def test_load_settings_reads_environment(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("IMPACTO_MISTRAL_KEY", "mk")
    monkeypatch.setenv("IMPACTO_MISTRAL_MODEL", "mistral-small-latest")
...
def test_load_settings_defaults(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("IMPACTO_MISTRAL_KEY", raising=False)
    monkeypatch.delenv("IMPACTO_MISTRAL_MODEL", raising=False)
